...
c	IF (id(16).EQ.1095303168.AND.id(17).EQ.1377828864) scan_mode='AIR'
c	IF (id(16).EQ.1129250816.AND.id(17).EQ.1347158016) scan_mode='COP'
c	IF (id(16).EQ.1129447424.AND.id(17).EQ.1411383296) scan_mode='CRT'
